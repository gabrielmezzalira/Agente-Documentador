      ...
      {activeTab === "sprints" && (
        <>
          <TutorialBanner heading="Sprints e Documentação" steps={[
            ...
            { title: "Planning", body: "Clique no chip 'Planning' na sprint. Você pode fazer upload de uma ata, PDF, texto com o que foi decidido — ou um print/arquivo do kanban com as tasks da sprint. O DocuData extrai tarefas, decisões e próximos passos automaticamente. Dica: quanto mais rico o arquivo, melhor o documento gerado." },
            ...
            { title: "Review", body: "Ao final da sprint, registre o review (demo para o cliente, ata de review). O documento gerado já inclui automaticamente o estado atual de todas as tasks da sprint — concluídas, em andamento e não iniciadas — sem precisar listar manualmente. Além disso, o DocuData detecta tasks mencionadas no texto e cria sugestões de mover para 'Concluída' na aba Tasks." },
