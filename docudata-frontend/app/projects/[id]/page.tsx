      ...
      {activeTab === "sprints" && (
        <>
          <TutorialBanner heading="Sprints e Documentação" steps={[
            ...
            { title: "Planning", body: "Clique no chip 'Planning' na sprint. Você pode fazer upload de uma ata, PDF, texto com o que foi decidido — ou um print/arquivo do kanban. Além do arquivo, a IA captura automaticamente o estado atual das tasks da sprint no kanban (coluna, pontos, bloqueios) no momento em que você clica em 'Gerar' — então quanto mais tasks estiverem cadastradas na aba Tasks, mais preciso o planning gerado. Também é possível escrever o planning manualmente, sem IA, pelo botão 'Escrever sem IA'." },
