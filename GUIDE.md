...
| Variável | Uso |
|---|---|
| `DOCUDATA_APP_SECRET` | Segredo compartilhado enviado pelo frontend e hook legado. |
...
| `NEXT_PUBLIC_DOCUDATA_APP_SECRET` | Mesmo segredo compartilhado do backend. |

Nenhuma credencial do GitHub App usa prefixo `NEXT_PUBLIC_`.
