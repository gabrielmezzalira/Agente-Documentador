...
_SYSTEM_PROMPT = (
    ...
    "no formato 'nome da tarefa — Prazo: [prazo se visivel] — DoD: [criterio de pronto se visivel]'. "
    "Se prazo ou criterio nao estiverem visiveis no conteudo, omita essa parte (nao invente). "
