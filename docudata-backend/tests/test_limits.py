...
def test_apenas_endpoints_de_ia_e_autenticacao_tem_rate_limit():
    ...
    assert set(limiter._route_limits) == {
        ...
        "routers.enrich.enrich_planning_com_correlacoes",
        "routers.commit_ingest.ingest_commit",
        "routers.revisao_ingest.ingest_revisao",
        "routers.composer.gerar_planning",
        "routers.funcionalidades.importar_funcionalidades",
        "routers.funcionalidades.importar_funcionalidades_arquivo",
        "routers.boletins.criar_boletim",
